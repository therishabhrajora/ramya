...
function FilterCollection() {
  ...
  const products = allCollections.filter(
    (product) => product.gender.toLowerCase() == category.c.toLowerCase()
  );
  ...
  const sortedMenProducts = [...products].sort(sortFunctions[sortBy]);
        ...
        <section className="menfilterResults">
          {filterproducts.length == 0
            ...
            : filterproducts.map((scrub) => (
              <div className="menscrubCard" onClick={() => navigate(`/collections/${category.c}/${scrub.productId}`)} key={scrub.productId}>
                <div className="menscrubImage">
                  <img src={scrub.image} alt={scrub.name} />
                </div>
                <div className="menscrubDetails">
